...
## The headline result (validated tonight)
On the **full-data cached probe** (the trustworthy arbiter), only the CLEAN-data
v3 lineage beats the Meta anchor. The data fix (black-clip filter) is the cause.
