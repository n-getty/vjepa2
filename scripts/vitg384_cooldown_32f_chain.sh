...
# configs/vitg16_surg_vid_webdataset_single4/vitg384_cooldown_32f.yaml and memory
...
#   qsub /lus/flare/projects/ModCon/ngetty/vjepa2/scripts/vitg384_cooldown_32f_chain.sh
#
#PBS -N vitg_cd
#PBS -A ModCon
#PBS -q debug-scaling
...
BASE_CFG=$ROOT/configs/vitg16_surg_vid_webdataset_single4/vitg384_cooldown_32f.yaml
RUNTIME_CFG=$ROOT/.runtime_configs/n16g12_weak/configs/vitg16_surg_vid_webdataset_single4/vitg384_cooldown_32f.yaml
...
CKPT_DIR=/flare/ModCon/ngetty/checkpoints/surg_2_1_vitg384_cooldown/vitg384_cd32f_n16g12_weak
PARAMS=$CKPT_DIR/params-pretrain.yaml
SELF=$ROOT/scripts/vitg384_cooldown_32f_chain.sh
