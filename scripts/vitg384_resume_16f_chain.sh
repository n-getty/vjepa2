...
# configs/vitg16_surg_vid_webdataset_single4/vitg384_resume_16f.yaml and memory
...
#   qsub /lus/flare/projects/ModCon/ngetty/vjepa2/scripts/vitg384_resume_16f_chain.sh
#
#PBS -N vitg_rs
#PBS -A ModCon
#PBS -q debug-scaling
...
BASE_CFG=$ROOT/configs/vitg16_surg_vid_webdataset_single4/vitg384_resume_16f.yaml
RUNTIME_CFG=$ROOT/.runtime_configs/n16g12_weak/configs/vitg16_surg_vid_webdataset_single4/vitg384_resume_16f.yaml
...
CKPT_DIR=/flare/ModCon/ngetty/checkpoints/surg_2_1_vitg384_resume/vitg384_rs16f_n16g12_weak
PARAMS=$CKPT_DIR/params-pretrain.yaml
SELF=$ROOT/scripts/vitg384_resume_16f_chain.sh
...
DS_QUEUED=$(qstat -u $USER 2>/dev/null | awk '$4=="vitg_rs" && $10=="Q"' | wc -l)
