...
#   qsub /lus/flare/projects/ModCon/ngetty/vjepa2/scripts/v2_cleanbug_chain_debugscaling.sh
#
#PBS -N v2_cleanbug_chain
#PBS -A ModCon
#PBS -q debug-scaling
#PBS -l select=16
...
BASE_CFG=$ROOT/configs/vitl16_surg_vid_webdataset_single4/v2_cleanbug_regrecipe.yaml
RUNTIME_CFG=$ROOT/.runtime_configs/n16g12_weak/configs/vitl16_surg_vid_webdataset_single4/v2_cleanbug_regrecipe.yaml
PY=/opt/aurora/26.26.0/frameworks/aurora_frameworks-2025.3.1/bin/python
CKPT_DIR=/flare/ModCon/ngetty/checkpoints/surg_2_1_v2_cleanbug/from_meta_regrecipe_n16g12_weak
PARAMS=$CKPT_DIR/params-pretrain.yaml
SELF=$ROOT/scripts/v2_cleanbug_chain_debugscaling.sh
