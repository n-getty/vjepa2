...
CKPT_DIR=/flare/ModCon/ngetty/checkpoints/SPIKETEST_vitG384/trueaccum_n16g12
...
echo "HSDP 16n: WORLD_SIZE=$WORLD_SIZE LOCAL_WORLD_SIZE=$LOCAL_WORLD_SIZE FSDP_SHARDING=$FSDP_SHARDING TRUE_ACCUM=$VJEPA_TRUE_ACCUM MASTER_ADDR=$MASTER_ADDR"
