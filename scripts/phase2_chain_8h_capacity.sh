...
SELF=$ROOT/scripts/phase2_chain_8h_capacity.sh
...
# --- LOCK GUARD ------------------------------------------------------------
# The debug-scaling chain (phase2_chain_debugscaling.sh) targets the SAME
# CKPT_DIR. Prevent both training v1 concurrently (would corrupt
