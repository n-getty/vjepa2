...
CKPT_DIR=/flare/ModCon/ngetty/checkpoints/SPIKETEST_vitG384/hsdp_2n_fullshard
...
export VJEPA_DIST_STRATEGY=hsdp LOCAL_WORLD_SIZE=12 FSDP_SHARDING=full_shard
...
timeout 900 mpiexec --pmi=pmix -n 24 -ppn 12 --cpu-bind depth --depth 16 \
