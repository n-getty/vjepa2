...
CKPT_DIR=/flare/ModCon/ngetty/checkpoints/SPIKETEST_vitG384/pt213_fpcs8_n16g12
...
d["data"]["dataset_fpcs"] = [8]*len(d["data"]["dataset_fpcs"])  # TEST D: halve activations 16->8
